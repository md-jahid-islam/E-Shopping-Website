            ...
            {subscription ? (
              ...
              <div className="w-full flex-col xl:flex-row flex justify-between items-center gap-4">
                ...
                <button
                  ...
                  className="bg-white text-lightText w-[30%] h-10 hover:bg-green-600 rounded-md hover:scale-105 transition hover:text-white duration-300 text-base tracking-wide"
                >
                  Subscribe
                </button>
              </div>
